/**
 * Amazon Spending Analysis / Ausgaben-Analyse – Content Script v5.8
    ...
    panel.innerHTML =
      '<div class="aa-card">' +
        '<div class="aa-header">' +
          ...
          '<span class="aa-title">'+ct('title')+' <span style="font-size:10px;color:#5E6B80;font-weight:400">5.8</span></span>' +
